...
import { Box, Heading, Text,HStack, Image, Button, Flex, Link } from "@chakra-ui/react";
...
export default function TopContainer() {
  return (
    <>
      <Box mt={'10px'}>
        {/* left  */}
        <HStack backgroundImage={'images/back.webp'} backgroundSize='contain' py={'100px'}>
        <Box w={'50%'} color='white' pl={'44'} >
          ...
          <Button colorScheme={'blue'} mt='20px' >Buy Now</Button>
          <Button colorScheme={'blue'} variant="outline" ml={'12px'} mt='20px'>View Components</Button>
...
<Text mt={5} ml={3}> Created by : <Link href="https://github.com/Mr-Babarkhan" target={'_blank'} color='blue.500'>Babar khan</Link></Text>
</Flex>
        </Box>
        {/* right */}
